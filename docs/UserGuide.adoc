...
== Finding all persons containing any keyword in their name: `find` or 'findIgnoreCase'
...
and persons matching at least one keyword will be returned (i.e. `OR` search). 'findIgnoreCase' is not case sensitive
====
